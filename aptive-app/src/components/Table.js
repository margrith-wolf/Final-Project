    ...
    <div className='table'>
        <div className='app-container'>
            <div className='top-content'>
                    <div>
                        <h2>Try out one of our premium <span>features</span></h2>
                        <p>Keep track of employees and update their data with ease.</p>
                    </div>
                </div>
            <form className='app-form' onSubmit={handleEditFormSubmit}>
                <table>
                    <thead>
                        <tr>
                            <th>Name</th>
            ...
            <h2 className='table-h2'>Add an <span>Employee</span></h2>
